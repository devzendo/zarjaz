...
public interface Transport {
    ...
    <T, R> void callClientMethodWithMultipleReturn(EndpointName name, Class<T> interfaceClass, Method method, Consumer<R> consumer, long methodTimeoutMilliSeconds, Object... args);
